...
export default function Index() {
  ...
  const mainPageTransition = () => {
    return (<div className="transform transition-all">test</div>)
  }
      ...
      <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-between absolute rounded-3xl shadow-lg bg-blue-100">
        ...
        <div className="mt-8 flex lg:mt-0 ml-12 lg:flex-shrink-0">
          <div className="inline-flex rounded-md shadow">
            <a href="#" className="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-white bg-green-600 hover:bg-green-700 transform transition-all hover:scale-105" onClick={mainPageTransition}> Let's Go! </a>
          </div>
